        ...
        {isOpen && (
            <div className="absolute right-0 mt-2 w-56 bg-white rounded-xl shadow-lg border border-gray-100 py-2 z-50">
                ...
                <a href="" onClick={(e) => {
                    e.preventDefault();
                    navigate('/profile');
                }} className="block px-2 py-2 text-sm text-gray-700 hover:bg-gray-50 transition-colors cursor-pointer">View Profile</a>

                <div className="border-t border-gray-100 mt-2 pt-2">
                    <a href="" onClick={(e) => {
                        e.preventDefault();
                        onLogout();
                    }} className="block px-4 py-2 text-red-600 hover:text-red-500  hover:bg-red-50 transition-colors duration-200">Sign out</a>
                </div>
            </div>
