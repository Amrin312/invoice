      ...
      <div className="flex items-center justify-center min-h-screen px-4 text-center">
        ...
        <div className="bg-white rounded-lg shadow-xl max-w-lg w-full p-6 relative text-left transform transition-all">
          <div className="flex item-center justify-between mb-4">
            ...
            <button className="text-slate-400 hover:text-slate-600 cursor-pointer" onClick={onClose}>&times;</button>
          </div>
          ...
          <div className="flex justify-end space-x-3 mt-6">
            ...
            <Button onClick={handlCopyToClipboard} icon={hasCopied ? Check : Copy} disabled={isLoading}>
