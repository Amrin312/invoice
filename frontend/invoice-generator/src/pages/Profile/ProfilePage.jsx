        ...
        <div className="p-6 space-y-6">
          <div className="">
            ...
            <div className="relative">
              ...
              <input type="email" name="email" className='w-full h-10 pl-10 pr-3 py-2 border border-slate-200 rounded-lg bg-slate-50 text-slate-500 disabled:cursor-not-allowed ' value={user?.email || ''} disabled id="" />
            </div>
          </div>

          <InputField label="Full Name" name="name" icon={User} type="text" value={formData.name} onChange={handleInputChange} d="Enter your full name" />
          ...
          <div className="pt-6 border-t border-slate-200">
            ...
            <div className="space-y-4">
                <InputField label="Business Name" name="businessName" icon={Building} type='text' value={formData.businessName} onChange={handleInputChange} placeholder="Your Company Name" />

                <TextareaField label="Address" name="address" icon={MapPin} value={formData.address} onChange={handleInputChange} placeholder="123, Main Street, Anytown, India" />

                <InputField label="Phone" name="phone" icon={Phone} type='tel' value={formData.phone} onChange={handleInputChange} placeholder="+91 985467755" />
